    ...
    def export_xlsx_action(self):
        ...
        for location in locations:
            ...
            for value in inv_lines:
                ...
                inventory_values.write(index, 3, value.location_id.display_name.replace(" €€", ""), text_format)
        ...
        for location in locations:
            ...
            for value in inv_lines:
                ...
                external_inventory_values.write(index, 3, value.location_id.display_name.replace(" €€", ""), text_format)
