$(document).ready(function () {
    $('.main_faq .faq_header').click(function() {
		...
		$('.ingredients').each(function() {
			$(this).find('.ingredients_header').click(function() {
    ...
    var clock;
        ...
        if($('.duration_get').data('duration')){
            ...
            console.log(">>>>>>>>>duration_get",)
		    clock.setTime($('.duration_get').data('duration'));
