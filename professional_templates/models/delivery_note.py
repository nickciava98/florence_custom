...
class DN(models.Model):
    ...
    def onchange_partner_style(self):
        ...
        self.pk_style = self.partner_id.style or self.company_id.df_style or self.env.ref(
            'professional_templates.df_style_for_all_reports').id
        self.dn_style = self.partner_id.style or self.company_id.df_style or self.env.ref(
            'professional_templates.df_style_for_all_reports').id
    ...
    dn_style = fields.Many2one(
        ...
        default=lambda self: self.partner_id.style or self.company_id.df_style)
