...
class PO(models.Model):
    ...
    def onchange_partner_style(self):
        self.po_style = self.partner_id.style or self.company_id.df_style or self.env.ref(
            'professional_templates.df_style_for_all_reports').id
        self.rfq_style = self.partner_id.style or self.company_id.df_style or self.env.ref(
            'professional_templates.df_style_for_all_reports').id
