...
class ProductsPortal(CustomerPortal):
    ...
    def portal_products(self, page=1, sortby=None, filterby=None, **kw):
        ...
        lfa_i_stock_nv = request.env["stock.location"].sudo().search([("complete_name", "=", "LFA I/Stock-NonVendibile")])
        ...
        searchbar_filters = {
            ...
            "lfa_i_stock_nv": {"label": _("LFA I/Stock-NonVendibile"), "domain": [("location_id", "=", lfa_i_stock_nv.id)]},
